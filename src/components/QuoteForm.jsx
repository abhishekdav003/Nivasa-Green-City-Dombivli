  ...
  return (
    <div className="fixed top-0 right-0 w-[22%] lg:w-[22%] md:w-[30%] sm:w-[50%] h-full bg-white shadow-lg z-50 overflow-y-auto hidden lg:block">
      ...
      <div className="bg-gray-800 text-white p-2 flex items-center justify-between">
        <span className="text-md">Organize Site Visit</span>
        <a href="https://wa.me/918652814714" className="flex items-center">
          <img src="/whatsapp.png" alt="WhatsApp" className="w-6 h-6 mr-1" />
          <span>+91 8652814714</span>
        </a>
      </div>
      ...
      <form onSubmit={handleFormSubmit} className="space-y-4 px-4">
        <div>
          <input
            ...
            name="name"
            placeholder="Name"
            className="w-full px-2 py-2 border-b border-gray-300 text-gray-700 text-lg focus:outline-none"
            required
          />
        </div>
        ...
        <div className="flex border-b border-gray-300">
          ...
          <input
            ...
            className="w-full px-2 py-2 text-gray-700 text-lg focus:outline-none"
            required
          />
        </div>
        ...
        <div className="flex justify-center mt-4">
          <button
            type="submit"
            className="px-4 py-3 text-lg font-medium text-white bg-orange-500 rounded-md w-4/5"
          >
            Latest Offers
          </button>
        </div>
