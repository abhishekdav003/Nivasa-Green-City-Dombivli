...
const ProjectCardMobile = () => {
  ...
  return (
    <>
      <div id="enquiry" className="max-w-sm mx-auto block md:hidden rounded-xl shadow-md overflow-hidden border border-gray-200">
        <div className="px-4 py-2 text-center text-lg font-bold text-orange-500">
          BOOKING OPEN
        </div>
        
        <div className="p-4 text-center bg-white">
          <h2 className="text-2xl font-bold text-black">Nivasa Green City</h2>
          <p className="mt-1 text-md text-black">At Dombivli East</p>
          <p className="text-sm text-black">By Nivasa Group</p>
          ...
          <div className="mt-4 text-center">
            ...
            <div className="mt-1">
              <p className="text-xl font-bold text-black">Starts From ₹ 54.99 Lacs*</p>
            </div>
